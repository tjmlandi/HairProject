...
Mesh::Mesh(Vertex * vertices, int numVert, unsigned int * indices, int numIndices, ID3D11Device * device)
{
...
Mesh::Mesh(ID3D11Device * device, char * fileName)
{
	// File input object
	...
	this->indexBufferCount = vertCounter;
	// Create the VERTEX BUFFER description -----------------------------------
	// - The description is created on the stack because we only need
	//    it to create the buffer.  The description is then useless.
	D3D11_BUFFER_DESC vbd;
